				...
				<div className="row mb-50">
					<div className="col-md-4 mb-md-20 news-right">
						<div className="news-item alt-2 small">
							<div className="news-media">
								<img src="/images/img_men/about_1.jpg" data-at2x="images/news/img-13@2x.jpg"  />
							</div>
						</div>
					</div>
					<div className="col-md-4">
						<div className="news-item alt-2">
							<div className="news-media">
								<img src="/images/img_men/Banner_3.jpg" data-at2x="images/news/img-14@2x.jpg"  />
							</div>
						</div>
					</div>
					<div className="col-md-4 news-left">
						<div className="news-item alt-2 small">
							<div className="news-media">
								<img src="/images/img_men/Banner_4.jpg" data-at2x="images/news/img-15@2x.jpg"  />
							</div>
						</div>
					</div>
				</div>

				<h3 className="section-title bottom-line long font-alt">Welcome To Hair Crush<span>Loveliness Producers</span></h3>
