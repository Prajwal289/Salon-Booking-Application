...
function Login(props) {
  ...
  return (
    <div className='container'>
        ...
        <div className="container bg-brown align-center">
        ...
        <div className='col-12   '>
          <div className="col-xs-8 col-md-4 mb-30 pad ">
            <div className="news-item alt-2">
              <div className="news-media">
                <img src="/images/img_men/login_1.jpg" data-at2x="images/news/img-21@2x.jpg"  />
              </div>
            </div>
          </div>
          <div className="col-xs-4 col-md-2 mb-30 pad">
            <div className="news-item alt-2 mini mb-30">
              <div className="news-media">
                <img src="/images/img_men/login_2.jpg" data-at2x="images/news/img-22@2x.jpg"  />
              </div>
            </div>
            <div className="news-item alt-2 mini">
              <div className="news-media">
                <img src="/images/img_men/login_3.jpg" data-at2x="images/news/img-23@2x.jpg"  />
              </div>
            </div>
          </div>
                ...
                <h3 className="serv-title font-alt ">Login Form</h3>
                  ...
                  <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <form onSubmit={handleSubmit(handleLogin, handleError)}>
                      <div className="row">
                        <div className="col-lg-10 col-md-12 col-sm-12 col-xs-12 m-2">
                        ...
                        <div className="col-md-12">
                          <div className="form-group">
                            <button type="submit" id="submit" name="submit" className="button mb-10" >LOGIN</button>
                          </div>
                        </div>
                      </div>
                    </form>
