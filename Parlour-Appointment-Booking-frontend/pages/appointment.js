...
function Appointment(props) {
    ...
    return (
        <div>
			...
			<div className='col-6'>
                <div className="container bg-brown p-2 text-dark bg-opacity-10">
                <div className='row'>
                                ...
                                <form onSubmit={handleSubmit(handleRegistration, handleError)}>
                                    <div className="row">
                                        ...
                                        <div className="col-md-12">
                                            <div className="form-group">
                                                <button type="submit" id="submit" name="submit" className="button mb-10" disabled={login} >Book Appointment</button>
                                                <p className='font-weight-bold mt-10 '>
                                                    <Link href="/login" ><a className='app_colour'>Login</a></Link> &nbsp;
                                                    or &nbsp;
                                                    <Link href="/register" ><a className='app_colour'>Register</a></Link> &nbsp;
