				...
				<div className="col-xs-8 col-md-4 mb-30">
								<div className="news-item alt-2 mt-5">
									<div className="news-media">
										<img src="/images/img_men/haircut.jpg" data-at2x="images/news/img-21@2x.jpg"  />
									</div>
								</div>
							</div>
							<div className="col-xs-4 col-md-2 mb-30">
								<div className="news-item alt-2 mini mb-30">
									<div className="news-media">
										<img src="/images/img_men/Reg.jpg" data-at2x="images/news/img-22@2x.jpg"  />
									</div>
								</div>
								<div className="news-item alt-2 mini">
									<div className="news-media">
										<img src="/images/img_men/Reg_1.jpg" data-at2x="images/news/img-23@2x.jpg"  />
									</div>
								</div>
							</div>
