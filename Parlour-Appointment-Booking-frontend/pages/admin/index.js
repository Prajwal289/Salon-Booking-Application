...
const index = () => {
    return (
		...
		<section className="small-section bg-section-color3 opacity-20" data-background="/images/section-bg-3.jpg">
			...
			width={1400}
			height={1000}
			src="https://charts.mongodb.com/charts-project-0-kurgq/embed/dashboards?id=9fdec754-8bc9-4162-b836-58a8518f4f2c&theme=light&autoRefresh=true&maxDataAge=3600&showTitleAndDesc=true&scalingWidth=scale&scalingHeight=scale"></iframe>
			</div>
		</section>
        </div>
    )
